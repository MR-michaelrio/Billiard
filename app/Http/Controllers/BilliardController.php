...
class BilliardController extends Controller
{
    ...
    public function rekaptable1(){
        ...
        return $rentalinvoice["lama_waktu"];
        $hargarental = HargaRental::where('jenis', 'menit') -> first();
    ...
    public function rekaptable() {
        ...
        $startTime = Carbon::yesterday($timezone)->setTime(11, 0, 0)->setTimezone($timezone);
        $endTime = Carbon::today($timezone)->setTime(3, 0, 0)->setTimezone($timezone);
        return $endTime;
        ...
        if ($rentalinvoices->isEmpty()) {
            return view('invoice.rekap-order')->withErrors('No rental records found for the given time range.');
        }
